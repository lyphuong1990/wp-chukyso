...
class WPLP_Views_Config
{
    ...
    public function displayAboutTab()
    {
        ...
        wp_enqueue_script('javascript', plugins_url('/js/wplp_about.js', dirname(__FILE__)), array('jquery'), '1.0.0', true);
        ...
        if (!class_exists('WPLP_Addon_Admin')) {
            echo '<div class="card wplp_notice light-blue" style="margin-right:20px"><div class="card-content white-text" >';
        ...
        echo '<img src="' . plugins_url('img/wplp-logo-white.png', dirname(__FILE__)) . '" alt="JoomUnited Logo" /></a>';
        echo '</div></div>';
        echo '</div>';
    }
}
    ...
    */
    echo '<div id="wplp_config_zone_new" class="wpcu-inner-admin-block with-title with-border '.$classdisabled.$classdisabledsmooth.'">';
    ...
    */
    ...
    echo '<input id="dfThumbnail" '.$imageChecked.' type="checkbox" name="wplp_dfThumbnail" value="'.htmlspecialchars("Thumbnail").'">';
    ...
    */
    ...
    echo '<input id="dfTitle" '.$titleChecked.' type="checkbox" name="wplp_dfTitle" value="'.htmlspecialchars("Title").'">';
    ...
    */
    ...
    echo '<input id="dfAuthor"'.$authorChecked.' type="checkbox" name="wplp_dfAuthor" value="'.htmlspecialchars("Author").'">';
    ...
    */
    ...
    echo '<input id="dfDate"'.$dateChecked.' type="checkbox" name="wplp_dfDate" value="'.htmlspecialchars("Date").'">';
    ...
    */
    ...
    echo '<input id="dfCategory" '.$categoryChecked.' type="checkbox" name="wplp_dfCategory" value="'.htmlspecialchars("Category").'">';
    ...
    */
    ...
    echo '<input id="dfText"'.$textChecked.' type="checkbox" name="wplp_dfText" value="'.htmlspecialchars("Text").'">';
    ...
    */
    ...
    echo '<input id="dfReadMore"'.$readMoreChecked.' type="checkbox" name="wplp_dfReadMore" value="'.htmlspecialchars("Read more").'">';
